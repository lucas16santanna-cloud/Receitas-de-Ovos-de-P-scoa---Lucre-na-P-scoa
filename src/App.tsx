      ...
      <section id="offer" className="py-24 bg-[#fdfaf6]">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto bg-white p-12 rounded-[3rem] shadow-xl border border-[#eee]">
            ...
            <motion.a
              href="https://pay.kirvano.com/c5f61872-f448-4711-ab2b-9d14cb71c128"
              target="_blank"
              ...
              className="w-full bg-[#2ecc71] hover:bg-[#27ae60] text-white py-6 rounded-2xl text-2xl font-black shadow-lg shadow-[#2ecc71]/20 transition-all cursor-pointer flex items-center justify-center"
            >
